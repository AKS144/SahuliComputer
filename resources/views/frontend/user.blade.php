...
<div class="container" style="padding-top: 45px;">
    @foreach($pay as $pays)
        ...
        <div class="col-md-4">
            ...
            <img src="{{ asset('public/uploads/'.$pays->QR_image) }}" alt="" width="259" oncontextmenu="return false;">
        </div>
        @endforeach
    ...
    <p align="justify">
&nbsp;&nbsp;&nbsp;Step 1<br>
&nbsp;&nbsp;&nbsp;१) सर्वप्रथम वेबसाईटवर गुगल पे नंबर वर  / बँक अकाँट नंबर वर  / क्यू. आर. कोड स्कॅन करून वार्षिक फि रुपये ५९९ /- भरणे .<br><br> 
&nbsp;&nbsp;&nbsp;Step 2<br>
...
&nbsp;&nbsp;&nbsp;Step 4<br>
&nbsp;&nbsp;&nbsp;४) रेफरल नेम या टॅबवर आवश्यक असल्यास अन्य नाव टाकावे अन्यथा sahuli नाव टाकावे. <br><br>
&nbsp;&nbsp;&nbsp;Step 5<br>
