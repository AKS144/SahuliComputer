...
<div class="container " style="padding-top: 45px;">
        ...
        <form action="{{ route('contact.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="email" placeholder="Enter Address" required>
                        @if ($errors->has('email'))
                    ...
                    <div class="form-group">
                        <label for="exampleInputName">Job Post</label>
                        <input type="text" class="form-control" name="subject" placeholder="Enter Job Post" required>
    ...
    <div class="col-md-4">
        ...
        V. D. Gokhale Road</br>
        Taluka: Vengurla, District: Sindhudurg<br>
