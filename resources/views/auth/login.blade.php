...
<div class="row justify-content-center">
 <img src="setting/process.jpeg" class="float-right" style="padding-bottom:23px; width: 100%;">
 <br>
 <br>
 <br>
    <div class="col-md-8">
            ...
            <div class="card p-4">
                ...
                <div class="container">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <h1 class="text-center logotitle">{{ trans('panel.site_title') }}</h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                ...
                                <a class="btn btn-link px-0" href="/requestform" style="color: #2E459C;">
                                   ...
                                   नविन रजिस्ट्रेशन साठी येथे क्लिक करणे
