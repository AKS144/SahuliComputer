...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="{{ route("admin.payment.update",$payment->id) }}" method="PUT" enctype="multipart/form-data">

            @csrf

            <div class="form-group {{ $errors->has('plan') ? 'has-error' : '' }}">

                <label for="plan">Gpay</label>

                <input type="text" id="plan" name="GPAY" class="form-control" value="{{$payment->plan}}" required>
            ...
            <div class="form-group {{ $errors->has('GPAY') ? 'has-error' : '' }}">
                ...
                <input type="text" id="GPAY" name="GPAY" class="form-control" value="{{$payment->GPAY}}" required>
            ...
            <div class="form-group {{ $errors->has('bank_acc') ? 'has-error' : '' }}">
                ...
                <input type="text" id="bank_acc" name="bank_acc" class="form-control" value="{{$payment->bank_acc}}" required>
            ...
            <div class="form-group {{ $errors->has('ifsc') ? 'has-error' : '' }}">
                ...
                <input type="text" id="ifsc" name="ifsc" class="form-control" value="{{$payment->ifsc}}" required>
            ...
            <div class="form-group {{ $errors->has('branch') ? 'has-error' : '' }}">
                ...
                <input type="text" id="branch" name="branch" class="form-control" value="{{$payment->branch}}" required>
