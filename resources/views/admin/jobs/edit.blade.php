        ...
        <form action="{{ route("admin.jobs.update", [$job->id]) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('logo') ? 'has-error' : '' }}">
                ...
                <input type="file" name="job_file" accept="application/pdf">
                 <a href="{{ asset('public/jobfile/'."$job->job_file") }}" target="_blank">View pdf</a>
                @if($errors->has('logo'))
                    <em class="invalid-feedback">
                        {{ $errors->first('logo') }}
                    </em>
            ...
            <div class="form-group {{ $errors->has('logo') ? 'has-error' : '' }}">
                ...
                <input type="file" name="job_social" accept="image/jpeg,image/gif,image/png,image/x-eps">
                 <img src="{{ asset('public/jobsocial/'."$job->job_social") }}" width="200" height="200">
                @if ($errors->has('logo'))
            ...
            <div class="form-group {{ $errors->has('job_link') ? 'has-error' : '' }}">
                ...
                <input type="text" id="job_link" name="job_link" class="form-control" value="{{ old('job_link', isset($job) ? $job->job_link : '') }}">
                @if($errors->has('title'))
                    <em class="invalid-feedback">
