    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav" style="background: #6C757D !important;">
        <div class="container px-4">
            <a class="navbar-brand" href="/"> <!-- @foreach($setting as $key => $settings) -->
                                <img src="{{ asset('public/setting/sahulilogo.png') }}" >
        ...
        <div class="col-md-4">
                    <div id="carouselEx" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item {{ $advertisement_lefts->active }}">
                                <img class="d-block w-100" src="{{asset('public/advertisement/'.$advertisement_lefts->advt_image)
                ...
                <div class="col-md-4">
                        <div class="text-center">
                            ...
                            <a  href="/"><img src="{{ asset('setting/'.$settings->logo) }}" class="logo homelogo" style=""></a>
                            </a>@endforeach
                        </div>
                </div>
                <div class="col-md-4">
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item {{ $advertisement_rights->active }}">
                                <img class="d-block w-100" src="{{asset('public/advertisement/'.$advertisement_rights->advt_image)
                                }}" alt="First slide" style="height:230px !important;">
                            </div>
                            @endforeach
                        </div>
    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            ...
            <div class="carousel-item active ">
                <img class="d-block w-100 banner" src="{{asset('public/banner/'.$banners->banner_img) }}" alt="First slide" >
            </div>
            @endforeach
        </div>
