...
//for user url
        ...
        Route::group(['prefix' => 'user', 'as' => 'user.', 'namespace' => 'User', 'middleware' => ['auth']], function () {
            ...
            Route::resource('/recommendation','RecommendationController');
               Route::get('govtschcat/{categorys}', 'HomeController@govtschcat')->name('home.govtschcat');
                Route::get('pvtjobcat/{categorys}', 'HomeController@pvtjobcat')->name('home.pvtjobcat');
